...
//     version 1.4.4
//     from Assets/Source/Fishing Rod/HarpoonInput.inputactions
//
...
public partial class @HarpoonInput : IInputActionCollection2, IDisposable
{
    ...
    private IHarpoonActions m_HarpoonActionsCallbackInterface;
    ...
    public struct HarpoonActions
    {
        ...
        {
            if (m_Wrapper.m_HarpoonActionsCallbackInterface != null)
            {
                @Rotation.started -= m_Wrapper.m_HarpoonActionsCallbackInterface.OnRotation;
                @Rotation.performed -= m_Wrapper.m_HarpoonActionsCallbackInterface.OnRotation;
                @Rotation.canceled -= m_Wrapper.m_HarpoonActionsCallbackInterface.OnRotation;
            }
            m_Wrapper.m_HarpoonActionsCallbackInterface = instance;
            if (instance != null)
            {
